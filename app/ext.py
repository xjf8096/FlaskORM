...
def init_db_config(app):
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:1234@127.0.0.1:3306/flask?charset=utf8'
...
extensions:允许文件上传的类型 默认类型
default_dest设置文件上传的根目录'''
...
def init_upload_config(app):
    ...
    #生成文件的访问的url地址
    #app.config['UPKOADS_DEFAULT_URL']=''
    '''
    app Flask对象
    uploads_sets 文件上传对象'''
